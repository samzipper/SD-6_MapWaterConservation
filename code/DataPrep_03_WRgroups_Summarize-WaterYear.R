## DataPrep_03_WRgroups_Summarize-WaterYear.R
# This script is intended to summarize WaterYear ET, land cover, and irrigation status for each WR group.
...
fields_irrigation <- read_csv(file.path(dir_data, "OpenET", "Monthly_2016-2021", "OpenET_EstimateFieldIrrigation-WaterYear_FieldsNoDups.csv")) |> 
...
readr::write_csv(alldata_wrg, file.path("data", "WRgroups_Summarize-WaterYear.csv"))

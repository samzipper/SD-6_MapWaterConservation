## Map+Dens-ETbyField-GrowingSeason.R
...
p_et_map <-
  ...
  scale_fill_viridis_c(name = "Growing Season ET [mm]", direction = -1) +
  theme(axis.text = element_blank(),
        axis.ticks = element_blank(),
        legend.position = "bottom",
        legend.title = element_text(vjust = 0.75)) +
  NULL
ggsave(file.path("figures+tables", "Map-ETbyField-GrowingSeasonET.png"),
...
p_et.p_map <-
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(vjust = 0.75)) +
  NULL
ggsave(file.path("figures+tables", "Map-ETbyField-GrowingSeasonET-P.png"),
...
p_irr_map <-
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(vjust = 0.75)) +
  NULL
ggsave(file.path("figures+tables", "Map-ETbyField-GrowingSeasonIrr.png"),
...
p_et_dens <-
  ...
  facet_wrap( ~ Year) +
  scale_x_continuous(name = "Growing Season ET [mm]") +
  scale_color_brewer(labels = labs_algorithms, type = "qual") +
  scale_fill_brewer(labels = labs_algorithms, type = "qual") +
  theme(legend.position = "bottom") +
  NULL
ggsave(file.path("figures+tables", "Dens_ETbyField-GrowingSeasonET.png"), p_et_dens,
...
p_et.p_dens <-
  ...
  facet_wrap( ~ Year) +
  scale_x_continuous(name = "Growing Season ET - P [mm]") +
  scale_color_brewer(labels = labs_algorithms, type = "qual") +
  scale_fill_brewer(labels = labs_algorithms, type = "qual") +
  theme(legend.position = "bottom") +
  NULL
ggsave(file.path("figures+tables", "Dens_ETbyField-GrowingSeasonET-P.png"), p_et.p_dens,
       width = 150, height = 120, units = "mm")

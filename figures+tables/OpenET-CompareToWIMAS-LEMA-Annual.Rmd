---
title: "Compare OpenET and WIMAS irrigation at LEMA Scale"
output: rmarkdown::github_document
---

This script compares irrigation reported in the WIMAS dataset and estimated from OpenET data.
...
write_csv(df_wimas_irr_LEMA_fromWRG, file.path("..", "data", "WIMAS_LEMAtotalIrrigation_fromWRGs_ForAndreaPaper.csv"))
...
write_csv(df_OpenET_irr_total, file.path("..", "data", "OpenET_LEMAtotalIrrigation_ForAndreaPaper.csv"))

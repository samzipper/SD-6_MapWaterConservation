# RadarPrecip_Compare_OpenET-WIMAS_WRG.R
...
ggsave(file.path("figures+tables", "RadarPrecip_Compare_OpenET-WIMAS_WRG_IrrArea_AllWRGs.png"),
...
p_wrg_fit <-
  ...
  NULL
ggsave(file.path("figures+tables", "RadarPrecip_Compare_OpenET-WIMAS_WRG_IrrVolume_AllWRGs-AreaMatch.png"),
...
write_csv(df_fit_long, file.path("figures+tables", "RadarPrecip_Compare_OpenET-WIMAS_WRG_FitStats_AllWRGs-AreaMatch.csv"))
...
ggsave(file.path("figures+tables", "RadarPrecip_Compare_OpenET-WIMAS_WRG_IrrArea_SimpleWRGs.png"),
...
p_wrg_fit_simple <-
  ...
  guides(color = guide_legend(ncol = 1, title.hjust = 0.5)) +
  NULL
ggsave(file.path("figures+tables", "RadarPrecip_Compare_OpenET-WIMAS_WRG_IrrVolume_SimpleWRGs-AreaMatch.png"),
...
write_csv(df_fit_simple_long, file.path("figures+tables", "RadarPrecip_Compare_OpenET-WIMAS_WRG_FitStats_SimpleWRGs-AreaMatch.csv"))
...
ggsave(file.path("figures+tables", "RadarPrecip_Compare_OpenET-WIMAS_WRG_IrrVolume_AllWRGs.png"),
...
ggsave(file.path("figures+tables", "RadarPrecip_Compare_OpenET-WIMAS_WRG_IrrDepth_AllWRGs.png"),
...
ggsave(file.path("figures+tables", "RadarPrecip_Compare_OpenET-WIMAS_WRG_IrrDepth_AllWRGs-AreaMatch.png"),

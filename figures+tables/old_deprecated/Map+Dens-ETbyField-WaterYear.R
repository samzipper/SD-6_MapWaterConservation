## Map+Dens-ETbyField-WaterYear.R
...
p_et_map <-
  ...
  facet_grid(Algorithm ~ WaterYear) +
  coord_sf(xlim = c(extent["xmin"]-1000, extent["xmax"]+1000), 
           ylim = c(extent["ymin"]-1000, extent["ymax"]+1000)) +
  scale_x_continuous(expand = c(0,0)) +
  scale_y_continuous(expand = c(0,0)) +
  scale_fill_viridis_c(name = "Water Year ET [mm]", direction = -1) +
  theme(axis.text = element_blank(),
        axis.ticks = element_blank(),
        legend.position = "bottom",
        legend.title = element_text(vjust = 0.75)) +
  NULL
ggsave(file.path("figures+tables", "Map-ETbyField-WaterYearET.png"),
...
p_et.p_map <-
  ...
  scale_x_continuous(expand = c(0,0)) +
  scale_y_continuous(expand = c(0,0)) +
  scale_fill_gradient2(name = "Water Year ET - P [mm]",
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(vjust = 0.75)) +
  NULL
ggsave(file.path("figures+tables", "Map-ETbyField-WaterYearET-P.png"),
...
p_irr_map <-
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(vjust = 0.75)) +
  NULL
ggsave(file.path("figures+tables", "Map-ETbyField-WaterYearIrr.png"),
...
p_et_dens <-
  ...
  scale_x_continuous(name = "Water Year ET [mm]") +
  scale_color_brewer(labels = labs_algorithms, type = "qual") +
  scale_fill_brewer(labels = labs_algorithms, type = "qual") +
  theme(legend.position = "bottom") +
  NULL
ggsave(file.path("figures+tables", "Dens_ETbyField-WaterYearET.png"), p_et_dens,
...
p_et.p_dens <-
  ...
  facet_wrap( ~ WaterYear) +
  scale_x_continuous(name = "Water Year ET - P [mm]") +
  scale_color_brewer(labels = labs_algorithms, type = "qual") +
  scale_fill_brewer(labels = labs_algorithms, type = "qual") +
  theme(legend.position = "bottom") +
  NULL
ggsave(file.path("figures+tables", "Dens_ETbyField-WaterYearET-P.png"), p_et.p_dens,
       width = 150, height = 120, units = "mm")
